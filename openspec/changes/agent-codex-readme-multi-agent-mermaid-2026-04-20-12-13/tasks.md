...
- [x] 1.1 Finalize proposal scope and acceptance criteria for `agent-codex-readme-multi-agent-mermaid-2026-04-20-12-13`.
- [x] 1.2 Define normative requirements in `specs/readme-multi-agent-mermaid/spec.md`.

## 2. Implementation

- [x] 2.1 Implement scoped behavior changes.
- [x] 2.2 Add/update focused regression coverage (docs-only diagram update; no runtime/test surface changed).
